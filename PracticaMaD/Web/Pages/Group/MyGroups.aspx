<%@ Page Title="" Language="C#" MasterPageFile="~/PracticaMaD.Master" AutoEventWireup="true" CodeBehind="MyGroups.aspx.cs" Inherits="Es.Udc.DotNet.PracticaMaD.Web.Pages.Group.MyGroups" 
        ...
        <div class="field" > 
            ...
            <asp:GridView ID="gvGroups" runat="server" CssClass="products"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="btnLeaveGroup" runat="server" CommandArgument='<%# Eval("groupId") %>' OnClick="btnLeaveGroup_Click"  meta:resourcekey="btnLeaveGroup"> </asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>  
